...
-- November seems to be the month, lets see what product do they sell in November, Classic I believe
...
SELECT PRODUCTCODE, (SUM(SALES) - SUM(QUANTITYORDERED * PRICEEACH)) / SUM(SALES) AS PROFIT_MARGIN
FROM [dbo].[sales_data_sample]
...
-- What is the average order size by product line and customer location?
SELECT PRODUCTLINE, COUNTRY, AVG(QUANTITYORDERED) AS AVG_ORDER_SIZE
FROM [dbo].[sales_data_sample]
